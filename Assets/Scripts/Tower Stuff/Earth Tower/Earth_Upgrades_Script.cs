...
public class Earth_Upgrades_Script : MonoBehaviour
{
    ...
    public void upgrade1_1() // makes turret tower shoot 25% faster
    {
        ...
        if (checkMoney(PlayerStats.cash, temp.upgd1_1Cost))
        {
            ...
            tower.transform.Find("axel").gameObject.GetComponent<MeshRenderer>().material = sphereU1_1Colour;
            UI.resetButtons();
        }
    }
    ...
    public void upgrade1_2() // makes turret tower shoot 25% faster
    {
        ...
        if (checkMoney(PlayerStats.cash, temp.upgd1_2Cost))
        {
            ...
            tower.transform.Find("axel").gameObject.GetComponent<MeshRenderer>().material = sphereU1_2Colour;
            UI.resetButtons();
        }
    }
